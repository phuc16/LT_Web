            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="text-box mt-5 mb-5">
                        ...
                        <?php endif;?>
                        <?php endwhile; ?>
                        <form class="row g-3 needs-validation infoForm" action="updateStaff.php" method="post" novalidate >
                            <div class="mb-4 row ">
                            ...
                            <div class="mb-3 d-grid gap-2">
                                ...
                                <a class="btn btn-outline-danger" href="manage.php" type="submit" id="signup"  name="update">Trở về</a>
                            </div>
                        </form>
