...
<div class="container" id="main">
    <div class="main row py-3 d-flex align-items-center" id="main-top">
        <div class="col-lg-4">
            <img class="rounded mx-auto d-block" src="http://mauweb.monamedia.net/vmax/wp-content/uploads/2019/05/Mona-designstyle-colors-m.png" alt="">
        </div>
    ...
    <div class="container main py-3" id="main-center">
        <div class="row">
            <div class="col-auto col-lg-12 justify-content-center text-center align-items-center justify-content-lg-between">
                ...
                <p>Mona Media luôn luôn mong muốn đáp ứng được nhu cầu mua sắm sản phẩm giá tốt với chất lượng đảm bảo<br> và dịch vụ hậu mãi chu đáo, cũng như mang lại trải nghiệm mua hàng tuyệt vời đến với khách hàng.</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6" data-aos="zoom-in">
                <div class="d-flex align-items-start"><img class="me-4" src="./public/img/icon-1.png" alt="...">
                    <div class="flex-1">
                        ...
                        <p>Mực in Vmax là giải pháp in ấn tiết kiệm, giúp công ty cắt giảm chi phí in ấn đến mức tối đa 30-60%, tiết kiệm trên mỗi bản in. Máy in, thiết bị văn phòng hay văn phòng phẩm tại Vmax luôn đảm bảo ở mức giá tốt nhất cho khách
                            hàng
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-start"><img class="me-4" src="./public/img/icon-2.png" alt="...">
                    <div class="flex-1">
                        ...
                        <p>Đặc biệt, mực in Vmax được sản xuất theo công nghệ Mỹ và nguyên vật liệu từ Nhật Bản như drum Fuji, mực Sakata; kết hợp với tiêu chuẩn của Hiệp hội mực in quốc tế I-ITC và quản lý chất lượng ISO</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex align-items-start"><img class="me-4" src="./public/img/icon-3.png" alt="...">
                    <div class="flex-1">
                        ...
                        <p>Mona Media luôn mong muốn mang đến cho Khách hàng những quyền lợi đặc biệt khi đồng hành cùng Vmax qua các chương trình khuyến mãi, tri ân, quà tặng vào các dịp đặc biệt cực kì hấp dẫn</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex align-items-start"><img class="me-4" src="./public/img/icon-4.png" alt="...">
                    <div class="flex-1">
                        ...
                        <p>Cam kết bảo hành đến giọt mực cuối cùng, nhanh chóng xử lý sự cố để không làm gián đoạn công việc. Nếu xảy ra do lỗi mực in Vmax gây ra, Vmax sẽ chịu trách nhiệm sửa chữa hoặc tặng ngay máy in mới.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex align-items-start"><img class="me-4" src="./public/img/icon-5.png" alt="...">
                    <div class="flex-1">
                        ...
                        <p>Mona Media là đại diện Bảo hành, Sửa chữa và Cung cấp phụ tùng, linh kiện thay thế cho nhà sản xuất với đội ngũ kỹ thuật viên có kiến thức và trình độ cao, năng động nhiệt tình.</p>
                    </div>
                </div>
            </div>
        </div>
