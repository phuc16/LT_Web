    ...
    <div class="row">
        <aside class="col-md-3 side">
            <form method="post" action="" class="input-group">
                <div class="form-outline">
                    <input type="search" name="accessoriesSearchInput" class="form-control px-2" placeholder="Tìm kiếm..." value="<?php if (isset($_POST["accessoriesSearch"])) echo $data['Search']?>"/>
                </div>
                <button type="submit" class="btn btn-success" name="accessoriesSearch">
        ...
        <div class="col-md-9 col-sm-12">
            <div class="row">
                ...
                ?> 
            <?php
                while($row = mysqli_fetch_array($data["Accessories"])){ ?>
