...
<div class="container" style="margin-bottom: 5%;">
    ...
    <div class="row">
        <aside class="col-md-3 side">
            <form method="post" action="" class="input-group">
                <div class="form-outline">
                    <input type="search" name="printerSearchInput" class="form-control px-2" placeholder="Tìm kiếm..." value="<?php if (isset($_POST["printerSearch"])) echo $data['Search']?>"/>
                </div>
                <button type="submit" class="btn btn-success" name="printerSearch">
        ...
        <div class="col-md-9 col-sm-12">
            <div class="row">
                <?php if (isset($_POST["printerSearch"]) && $_POST["printerSearchInput"] != ''){?>
                    <p>Có <?php echo $data["Printer"]->num_rows?> kết quả phù hợp với tìm kiếm</p>
                <?php 
                    }
                ?> 
                <?php
