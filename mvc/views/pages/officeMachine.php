...
<div class="container" style="margin-bottom: 5%;">
    ...
    <div class="row">
        <aside class="col-md-3 side">
            <form method="post" action="" class="input-group">
                <div class="form-outline">
                    <input type="search" name="officeMachineSearchInput" class="form-control px-2" placeholder="Tìm kiếm..." value="<?php if (isset($_POST["officeMachineSearch"])) echo $data['Search']?>"/>
                </div>
                <button type="submit" class="btn btn-success" name="officeMachineSearch">
        ...
        <div class="col-md-9 col-sm-12">
            <div class="row">
                <?php if (isset($_POST["officeMachineSearch"]) && $_POST["officeMachineSearchInput"] != ''){?>
                    <p>Có <?php echo $data["OfficeMachine"]->num_rows?> kết quả phù hợp với tìm kiếm</p>
                <?php 
                    }
                ?> 
            <?php
                while($row = mysqli_fetch_array($data["OfficeMachine"])){?>
                    <div class="card col-sm-4 col-md-3">
                        <img class="card-img-top" src="<?php echo $row["image"]?>" alt="Image" style="width:40%; margin-left: 30%;">
                        <div class="card-body">
