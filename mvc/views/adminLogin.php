...
<body>
    <div id="login">
        ...
        <div class="container" style="margin-top: 120px; max-width: 650px; height: 320px; border: 1px solid #9C9C9C; background-color: #EAEAEA; margin-top:10px">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" method="post" style="margin-top: 5%">
